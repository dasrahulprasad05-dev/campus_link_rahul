...
window.__API_URL__ = window.__API_URL__ || localStorage.getItem('CAMPUSLINK_API_URL') || (window.location.hostname.includes('vercel.app') ? 'https://node-js-web-app.onrender.com' : '');
